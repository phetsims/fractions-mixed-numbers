 ...
 * please modify fractions-mixed-numbers/package.json to control dependencies.
 *
 * RequireJS configuration file for the fractions-mixed-numbers sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'fractions-mixed-numbers-main' ],
